...
/turf/simulated/proc/PlanetOverlays_M()
	if(istype(get_step(src, NORTH), /turf/simulated/mineral))
		src.overlays += image('icons/turf/walls.dmi', "rock_side_n", layer=6)
...
/turf/simulated/proc/tempOverlays()
	if (src.temperature < 233.15)
		src.overlays += image('icons/turf/overlays.dmi', "snowfloor", layer=2.1)
	else if (src.temperature >= 233.25)
		src.overlays.Cut()
