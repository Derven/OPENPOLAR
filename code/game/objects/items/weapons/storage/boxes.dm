...
/obj/item/weapon/storage/box/shells
	name = "box of combat shells"
	desc = "Box of shotgun shells"
	icon_state = "ammo_red"
...
/obj/item/weapon/storage/box/wilderness
	name = "box of survival supplies"
	desc = "Open in case of starvation, dehydration, hypotermia or... blah-blah-blah, who cares, THERE'S CHOCOLATE AND VODKA INSIDE!"
	icon_state = "embox"
	...
	New()
		...
		new /obj/item/weapon/reagent_containers/food/snacks/chocolatebar(src)
		new /obj/item/weapon/reagent_containers/food/drinks/flask/survflask(src)
