...
/obj/machinery/vending/ammo
	name = "Sgt. Beepsky's Ammunition Supply"
	desc = "Ammo vending machine. Any caliber or filling!"
	icon_state = "ammo"
	icon_deny = "ammo-deny"
	req_access_txt = "1"

	products = list(/obj/item/weapon/storage/box/shells = 3,/obj/item/weapon/storage/box/stun = 5,/obj/item/weapon/storage/box/flashbangs = 2,
					/obj/item/ammo_magazine/box/c38 = 4)

	contraband = list(/obj/item/ammo_magazine/box/a357 = 3,/obj/item/weapon/storage/box/emps)
	premium = list(/obj/item/ammo_magazine/external/m50 = 2,/obj/item/ammo_magazine/external/m75 = 2)