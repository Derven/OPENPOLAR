...
/obj/machinery/weapon_dispenser/attack_hand(user as mob)
	...
	<HR>
	Guns:<BR>
	<A href='?src=\ref[src];make_gun=/obj/item/weapon/gun/projectile/automatic/pistol/beretta'>Beretta</A><BR>
	<A href='?src=\ref[src];make_gun=/obj/item/weapon/gun/projectile/SW'>ASwetlkwetlk</A><BR>
	<A href='?src=\ref[src];make_gun=/obj/item/weapon/gun/projectile/automatic/pistol'>Smith & Wesson</A><BR>
	<HR>
	Ammo:<BR>
