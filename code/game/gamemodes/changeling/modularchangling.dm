...
/* /datum/power/changeling/unknown_form
	name = "Formless"
	desc = "We debase ourselves and become formless."
	genomecost = 1
	verbpath = /mob/proc/changeling_unknown_form */
...
/datum/power/changeling/fakedeath_mud
	name = "Mudblood's Regenerative Stasis"
	desc = "You disable all your abilities to increase regenaritive rate and value of regenerative stasis."
	genomecost = 10
	verbpath = /mob/proc/changeling_mudblood_fakedeath
