	...
	switch(location)
		if(0)
			...
			if(timeleft>timelimit)
				...
				var/area/end_location = locate(/area/shuttle/train/centcom)
				var/area/buffer_location = locate(/area/shuttle/train/transit)
/*
...
*/
				...
				start_location.move_contents_to(buffer_location)
				end_location.move_contents_to(start_location)
				buffer_location.move_contents_to(end_location)
