...
/mob/living/carbon/human/show_inv(mob/user as mob)
	...
	<BR><B>Anal Slot:</B> <A href='?src=\ref[src];item=anal'>Anal</A>
...
/mob/living/carbon/human/Topic(href, href_list)
	...
	if ((href_list["item"] && href_list["item"] != "anal" && !( usr.stat ) && usr.canmove && !( usr.restrained() ) && in_range(src, usr) && ticker)) //if game hasn't started, can't make an equip_e
...
/mob/living/carbon/human/verb/hide_me()
