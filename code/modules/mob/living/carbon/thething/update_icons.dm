...
/mob/living/carbon/thething/regenerate_icons()
	..()
...
/mob/living/carbon/thething/update_icons()
	update_hud()
...
////////
/mob/living/carbon/thething/update_inv_wear_mask(var/update_icons=1)
...
/mob/living/carbon/thething/update_inv_r_hand(var/update_icons=1)
	if(r_hand)
...
/mob/living/carbon/thething/update_inv_l_hand(var/update_icons=1)
	if(l_hand)
...
/mob/living/carbon/thething/update_inv_back(var/update_icons=1)
	if(back)
...
/mob/living/carbon/thething/update_inv_handcuffed(var/update_icons=1)
	if(handcuffed)
		drop_r_hand()
		drop_l_hand()
		stop_pulling()
...
/mob/living/carbon/thething/update_hud()
	if (client)
		client.screen |= contents

//Call when target overlay should be added/removed
/mob/living/carbon/thething/update_targeted(var/update_icons=1)
