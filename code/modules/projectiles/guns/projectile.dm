/obj/item/weapon/gun/projectile
	...
	w_class = 3.0
	m_amt = 1000
	icon = 'icons/obj/gun_projectile.dmi'
...
/obj/item/weapon/gun/projectile/proc/fireflash(var/mob/user = null)
	if(silenced) return
	...
	A.SetLuminosity(A.luminosity + fire_brightness)
...
/obj/item/weapon/gun/projectile/Fire(atom/target as mob|obj|turf|area, mob/living/user as mob|obj, var/params = "", reflex = 0)
	. = ..()
	if(.) fireflash(user)
	return .
