...
/obj/effect/accelerated_particle/Bump(atom/A)
	if (A)
		if(ismob(A))
			toxmob(A)
		if((istype(A,/obj/machinery/the_singularitygen))||(istype(A,/obj/machinery/singularity/))||(istype(A,/obj/machinery/core_field_n/))||(istype(A,/obj/machinery/core_field_s/))||(istype(A,/obj/machinery/core_field_w/))||(istype(A,/obj/machinery/core_field_e/)))
			A:energy += energy
