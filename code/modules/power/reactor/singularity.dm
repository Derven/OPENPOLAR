...
/obj/machinery/singularity/proc/expand(var/force_size = 0)
	...
	switch(temp_allowed_size)
		...
		//	src.overlays += image('icons/obj/machines/core_field.dmi', "core_field", layer=6)
		...
		//	if((check_turfs_in(1,2))&&(check_turfs_in(2,2))&&(check_turfs_in(4,2))&&(check_turfs_in(8,2)))
			...
			command_alert("Core temperature is at critical mass, core refrigiration is required!", "Engineering section alert")
		...
		//	if((check_turfs_in(1,3))&&(check_turfs_in(2,3))&&(check_turfs_in(4,3))&&(check_turfs_in(8,3)))
			...
			for(var/mob/M in player_list)
				M << sound('sound/AI/Reactor_alert.ogg')
